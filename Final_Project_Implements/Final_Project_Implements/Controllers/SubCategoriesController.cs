...
namespace Final_Project_Implements.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CategoryId,Description,IsActive")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CategoryId,Description,IsActive")] SubCategory subCategory)
        {
