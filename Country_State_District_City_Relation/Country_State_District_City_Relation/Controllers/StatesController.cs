...
namespace Country_State_District_City_Relation.Controllers
{
    public class StatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CountryId,DisplayOrder,Description,IsActive")] State state)
        {
            ...
            ViewData["CountryId"] = new SelectList(_context.Country, "Id", "Title", state.CountryId);
            return View(state);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CountryId,DisplayOrder,Description,IsActive")] State state)
        {
            if (id != state.Id)
            {
                return NotFound();
