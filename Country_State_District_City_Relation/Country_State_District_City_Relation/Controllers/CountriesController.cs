...
namespace Country_State_District_City_Relation.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,DisplayOrder,Description,IsActive")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,DisplayOrder,Description,IsActive")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
