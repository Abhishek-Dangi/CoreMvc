...
namespace MyPrecticesCatSabcat.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Title,IsActive")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,Title,IsActive")] SubCategory subCategory)
        {
